This folder contains Reports, Presentation, Dataset, Trained Model, etc related to the project "Sentiment-Analysis of Code-Mixed Text".

The description of various files present in this folder are:

1. Project_Report.pdf --> It is a 40 Page Report that describes the complete Project.
